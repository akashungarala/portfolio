...
describe('Experience', () => {
  ...
  it('should display work experience items', () => {
    ...
    // Should show at least one company name - use getAllByText since multiple companies exist
  ...
  it('should display education items when education tab is active', async () => {
    ...
    // Should show education-related content - use getAllByText since multiple items may match
